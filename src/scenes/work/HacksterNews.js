    ...
    return (
      ...
      <motion.div initial="initial" animate="in" exit="out" variants={Animation.variants} transition={Animation.transition}>
        ...
        <div>
          ...
          <p aria-hidden="true" className="small-text spacing-small-top caption-text"><a target="_blank" href="https://www.hackster.io/news">You can view the live product on Hackster.io.</a></p>
        </div>

        <div>
          <h2 className="spacing-large-top">The problem</h2>
          <p>
        ...
        <div>
          ...
          <p aria-hidden="true" className="small-text spacing-medium-top spacing-medium-bottom caption-text">These are some of my initial sketches. I explored using cards before landing on an editorial style.</p>
          <p>
        ...
        <div>
          <h2 className="spacing-large-top">Prototyping</h2>
          <p>
          ...
          <p aria-hidden="true" className="small-text spacing-small-top spacing-medium-bottom caption-text">This first prototype screen is from the reader experience.</p>
          <p>
          ...
          <p aria-hidden="true" className="small-text spacing-small-top caption-text">This second prototype screen is the admin view from the author experience.</p>
        </div>

        <div>
          <h2 className="spacing-large-top">Remote usability studies</h2>
          <p>
        ...
        <div>
          <h2 className="spacing-large-top">Hand off</h2>
          <p>
        ...
        <div>
          <h2 className="spacing-large-top">Results</h2>
          <p>
