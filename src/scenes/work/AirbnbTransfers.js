    ...
    return (
      <motion.div initial="initial" animate="in" exit="out" variants={Animation.variants} transition={Animation.transition}>
        ...
        <div className="spacing-large-top">
          ...
          <p aria-hidden="true" className="small-text spacing-small-top spacing-medium-bottom caption-text">I used this lo-fi prototype to brainstorm with the developers on how a sheet pattern could be implemented. I scrapped the idea.</p>
          <p>
        ...
        <div className="spacing-large-top">
          ...
          <p aria-hidden="true" className="small-text spacing-medium-top spacing-medium-bottom caption-text">Good old paper and pen. I turned my research notes into design requirements in Google Docs.</p>
          <p>
        ...
        <div className="spacing-large-top">
          ...
          <p aria-hidden="true" className="small-text spacing-small-top caption-text">I made this landing page so I could share my designs with stakeholders across Airbnb's global offices.</p>
        </div>

        <div className="spacing-large-top">
          <h2>Gaining buy-in</h2>
          <p>
